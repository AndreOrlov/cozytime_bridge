...
- **Интерфейс:** I2C (Fast Mode Plus)
- **Питание:** 1.08-3.6V
- **Потребление (активный):** 0.4 µA
...
**Стандартная SHT4x формула (°C):**
```
T(°C) = -45 + 175 × (raw_ticks / 65535)
```

**CozyTime формула (°F):**
```
T(°F) = 0.179987 × raw_value - 40.02
```

Это означает, что CozyTime **не использует** стандартные 16-битные тики SHT4x,
а применяет собственную калибровку/масштабирование.
...
- `analyze_timestamp2.py` - Детальный анализ интервалов обновления
